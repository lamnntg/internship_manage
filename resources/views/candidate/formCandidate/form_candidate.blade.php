<div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="datetime" class="form-control {{ $errors->has('birthday') ? 'border-danger' : '' }}"
    ...
    @if (!empty($candidate->user_name))
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input disabled type="text" class="form-control" name="user_name" value="{{$candidate->user_name}}">
            </div>
        </div>
    @else
    <div class="form-group row">
        <label class="col-sm-2 col-form-label textR">Username</label>
        <div class="col-sm-10">
            <input required type="text" class="form-control {{ $errors->has('user_name') ? 'border-danger' : '' }}"
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label textR">Password</label>
        <div class="col-sm-10">
            <input type="password" class="form-control {{ $errors->has('password_confirmation') ? 'border-danger' : '' }}"
