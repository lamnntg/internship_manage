...
@section('content')
  ...
  <div class="card card-primary">
    ...
    <div class="card-body">
      <form  method='POST' action="{{route('config-testing.store')}}" id="formCreate">  
        @csrf
        <div class="form-group">
          <label for="name">Name Exam Configuration: </label>
          <input required type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="name">
          @error('name')
